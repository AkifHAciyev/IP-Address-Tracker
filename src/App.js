...
function App() {
		...
		try {
			const getInitialData = async () => {
				const res = await fetch(
					`https://geo.ipify.org/api/v2/country,city?apiKey=at_UCie4WNdBUB7LThXzT5jJN13iVII4&ipAddress&ipAddress=5.134.53.156`
				);
	...
	const getEnteredData = async () => {
		const res = await fetch(
			`https://geo.ipify.org/api/v2/country,city?apiKey=at_UCie4WNdBUB7LThXzT5jJN13iVII4&ipAddress&${
